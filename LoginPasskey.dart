...
class LoginPasskey extends StatefulWidget {
  //final Function(bool success) onLogin; // Updated to accept a boolean parameter
  final void Function(User) onLogin;
  LoginPasskey({Key? key, required this.onLogin}) : super(key: key);

  @override
  State<LoginPasskey> createState() => _LoginPasskeyState();
}

class _LoginPasskeyState extends State<LoginPasskey> {
  ...
  void signInWithEmailPassword() async {
    print('Sign In with email passkey button tapped');
    // Show loading circle
    showDialog(
      context: context,
      builder: (context) {
